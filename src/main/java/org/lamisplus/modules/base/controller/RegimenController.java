...
public class RegimenController {
    ...
    private static final String ENTITY_NAME = "regimens";
    ...
    @DeleteMapping("/{id}")
    public Boolean delete(@PathVariable Long id, @RequestBody Regimen regimen) throws RecordNotFoundException {
        return this.regimenService.delete(id, regimen);
    }
}
