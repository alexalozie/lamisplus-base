...
public class RegimenLineController {
    ...
    private static final String ENTITY_NAME = "regimen-lines";
    ...
    @DeleteMapping("/{id}")
    public Boolean delete(@PathVariable Long id, @RequestBody RegimenLine regimenLine) throws RecordNotFoundException {
        return this.regimenLineService.delete(id, regimenLine);
    }
}
