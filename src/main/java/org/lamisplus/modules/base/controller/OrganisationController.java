...
public class OrganisationController {
    ...
    private static final String ENTITY_NAME = "organisations";
    ...
    @DeleteMapping("/{id}")
    public Boolean delete(@PathVariable Long id, @RequestBody Organisation organisation) throws RecordNotFoundException {
        return this.organisationService.delete(id, organisation);
    }
}
