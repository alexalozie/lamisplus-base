...
public class DrugGroupController {
    ...
    private final String ENTITY_NAME = "drug-groups";
    ...
    @DeleteMapping("/{id}")
    public Boolean delete(@PathVariable Long id, @RequestBody DrugGroup drugGroup) throws RecordNotFoundException {
        return this.drugGroupService.delete(id, drugGroup);
    }
}
