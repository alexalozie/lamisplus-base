...
public class ApplicationCodesetController {
    ...
    public ResponseEntity<List<ApplicationCodeset>> getApplicationCodeByCodesetGroup(@RequestParam String codesetGroup) {
    ...
    //.........
    @GetMapping
    public ResponseEntity<List<ApplicationCodeset>> getAllApplicationCodesets() {
